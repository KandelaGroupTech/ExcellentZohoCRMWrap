    ...
    <Modal isOpen={isOpen} onClose={onClose} title="New Lead">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input required type="text" value={formData.Company} onChange={e => setFormData({...formData, Company: e.target.value})} className="mt-1 block w-full bg-white text-gray-900 rounded-md border-gray-300 shadow-sm focus:border-brand-red focus:ring-brand-red sm:text-sm p-2 border" />
        </div>
        <div>
